...
<template>
  <div class="Bucao_room" style="padding:10px">
    ...
    <el-breadcrumb prefix-icon="arrow-right-bold " style="width: 100%;margin-top: 10px;margin-left: 10px">
      ...
      <el-breadcrumb-item style="font-size: large; ">布草-病房信息</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索，切换 -->
    <el-row :gutter="23">
      <el-col :span="18">
  ...
  methods:{
    ...
    deleteBatch() {
      ...
      request.post("/Bucao_room/deleteBatch", this.ids).then(res => {
        if (res.code === '1') {
          this.$message.success("批量删除成功，一共成功删除了"+res.data+"条记录")
          this.load()
        } else {
    ...
    save()
    {
      if(this.form.roomId==null || this.form.rfidx==null)
      {
